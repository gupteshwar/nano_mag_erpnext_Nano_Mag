...
class StockController(AccountsController):
	...
	def validate_inspection(self):
		...
		if ((self.doctype in ["Purchase Receipt", "Purchase Invoice", "Delivery Note", "Sales Invoice"] and self.is_return == 1) or (not inspection_required_fieldname and self.doctype != "Stock Entry") or
